...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Des 2022 pada 15.46
...
CREATE TABLE `buku` (
  ...
  `genre_buku` varchar(100) CHARACTER SET latin1 NOT NULL,
...
(14, 'Matahari', 'Gramedia', 'Fantasi', 100000),
(25, 'Perihal Kamu', 'BetaAksara', 'Romance', 90000);
